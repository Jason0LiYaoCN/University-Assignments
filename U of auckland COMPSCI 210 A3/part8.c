...
int register_status(unsigned short mem[], unsigned short IR, short PC) {
	...
	switch (opcode) {
        case 0x0:{ /* BR */
            int status1,i;
            if (((CC == 'N')&&n)||((CC == 'P')&&p)||((CC == 'Z')&&z)){
                PC = PC + PCoffset9;
            }
            unsigned short PC2 = (unsigned short) (PC);
            unsigned short diff = (unsigned short) (PC) - mem[0];
            printf("after executing instruction\t0x0%x\n",IR);
        ...
        case 0x9:{ /* NOT */
            ...
            if((short)(value_reg5)<0){
                CC = 'N';
            }else if((short)(value_reg5)==0){
                CC = 'Z';
            }else{
                CC = 'P';
            }
		...
		case 0xA:{ /* LDI */
            ...
            if((short)(value_reg2)<0){
                CC = 'N';
            }else if((short)(value_reg2)==0){
                CC = 'Z';
            }else{
                CC = 'P';
            }
		...
		case 0xE:{ /* LEA */
            ...
            if((short)(value_reg1)<0){
                CC = 'N';
            }else if((short)(value_reg1)==0){
                CC = 'Z';
            }else{
                CC = 'P';
            }
